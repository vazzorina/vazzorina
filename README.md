...
- [Генетический алгоритм](https://github.com/vazzorina/Genetic-Algorithm) - реализация генетического алгоритма на С++ с использованием QML и QT для отображения графиков функций и популяций (В РАЗРАБОТКЕ)
