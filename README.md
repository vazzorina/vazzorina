...
- [Calcualtor](https://github.com/vazzorina/Calculator) - калькулятор на С++ для Android с использованием QML графики. Проект разрабатывается в рамках технического тестового задания перед собеседованием.
