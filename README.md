...
Я изучаю C++ и Qt, создаю учебные проекты и полезные утилиты.  
В будущем хочу стать профессиональным разработчиком и работать в крупных IT-компаниях.
...
- [Генетический алгоритм](https://github.com/vazzorina/Genetic-Algorithm) - реализация генетического алгоритма на С++ с использованием QML и QT для отображения графиков функций и популяций
- [SortPhoto2](https://github.com/vazzorina/SortPhoto2) - новая версия программы [SortPhoto](https://github.com/vazzorina/SortPhoto), разрабаотнная в рамках учебного проекта (QT Widgets, C++)
...
- [Weather](https://github.com/vazzorina/Weather) - виджет для рабочего стола с прогнозом погоды на C++ с использованием QML графики. Есть полноценный релиз с готовым инсталятором [Weather v1.0.0](https://github.com/vazzorina/Weather/releases/tag/v1.0.0)
